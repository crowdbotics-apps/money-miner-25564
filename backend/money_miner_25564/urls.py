"""money_miner_25564 URL Configuration
...
admin.site.site_header = "Money Miner"
admin.site.site_title = "Money Miner Admin Portal"
admin.site.index_title = "Money Miner Admin"

# swagger
api_info = openapi.Info(
    title="Money Miner API",
    default_version="v1",
    description="API documentation for Money Miner App",
)
